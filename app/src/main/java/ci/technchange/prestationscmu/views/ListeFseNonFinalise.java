...
public class ListeFseNonFinalise extends Fragment implements FseAdapter.OnItemClickListener{
    private RecyclerView recyclerView;
    private FseAdapter adapter;
    private List<FseItem> dataList;
    private FseServiceDb fseServiceDb;

    public ListeFseNonFinalise() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_liste_fse_non_finalise, container, false);
        // Initialisation de la RecyclerView


        recyclerView = view.findViewById(R.id.recyclerViewFNF);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        TextView textViewNoData = view.findViewById(R.id.textViewNoDataFNF);

        fseServiceDb = FseServiceDb.getInstance(getContext());
        List<FseAmbulatoire> fseList = fseServiceDb.getFseAmbulatoireByStatusProgres(0);
