...
public class PreviewActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localisationManager.setLocationUpdateCallback(new LocalisationManager.LocationUpdateCallback() {
            ...
            public void onLocationError(String error) {
                ...
                Toast.makeText(PreviewActivity2.this, "Erreur: " + error, Toast.LENGTH_LONG).show();
            }
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, API_URL, jsonBody,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            Toast.makeText(PreviewActivity2.this, "FSE envoyée avec succès à l'API", Toast.LENGTH_SHORT).show();
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toast.makeText(PreviewActivity2.this, "Erreur lors de l'envoi à l'API: " + error.getMessage(), Toast.LENGTH_LONG).show();
                ...
                NetworkUtils.uploadImageWithRetry(this, new File(imagePath),numTrans, new NetworkUtils.UploadCallback() {
                    ...
                    public void onError(String error) {
                        runOnUiThread(() -> {
                            progressBar.setVisibility(View.GONE);
                            btnSend.setVisibility(View.VISIBLE);
                            NetworkUtils.showErrorToast(PreviewActivity2.this, error);
                        });
                    }
                });
            } else {
    ...
    private void showSuccessDialog() {
        ...
        btnOk.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(PreviewActivity2.this, MainActivity.class);
