...
public class ListeFseFinalise extends Fragment implements FseAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_liste_fse_finalise, container, false);

        recyclerView = view.findViewById(R.id.recyclerViewFF);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        TextView textViewNoData = view.findViewById(R.id.textViewNoDataFF);

        fseServiceDb = FseServiceDb.getInstance(getContext());
        List<FseAmbulatoire> fseList = fseServiceDb.getFseAmbulatoireByStatusProgres(1);
